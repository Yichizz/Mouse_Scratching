...
def main():
    ...
    if recreate_data:
        frames_path = 'D:\\mouse_consecutive\\frames'
        labels_path = 'D:\\mouse_consecutive\\labels'

        # training: A 1-10, B 1-7, C 1-10 testing: D 1, E 1
        training_videos = ['A-1','A-2','B-2','C-4','C-6','F-3','F-5','I-5','J-1','K-1','K-4','J-1_begin', 'K-1_begin']
        testing_videos = ['D-1']  # leave the list empty if no testing videos
